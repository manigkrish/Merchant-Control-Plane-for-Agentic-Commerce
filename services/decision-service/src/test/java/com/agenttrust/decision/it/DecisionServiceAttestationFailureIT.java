...
class DecisionServiceAttestationFailureIT extends RedisTestContainerSupport {
    ...
    @Test
    void attestationFailure_isPassedThrough_andTokenIsNotCalled() throws Exception {
        STUBS.resetCounters();
        STUBS.attestationFailUnauthorized();
        STUBS.tokenValid(java.util.UUID.randomUUID()); // should not be used

        String tenantId = "t_demo";
        String idemKey = "idem-attestation-fail";
